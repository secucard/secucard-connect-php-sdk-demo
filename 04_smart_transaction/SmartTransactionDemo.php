...
namespace SecucardConnect\Demo;
...
class SmartTransactionDemo
{
    ...
    public function simpleUsage()
    {
        ...
        Logger::logInfo($logger, 'Transaction started!');

        // "Print" receipt
        $receiptLines = $trans->receipt;

        foreach ($receiptLines as $line) {
            Logger::logInfo($logger, 'Receipt Line: ' . $line->type . ', ' . $line->value);
        }
